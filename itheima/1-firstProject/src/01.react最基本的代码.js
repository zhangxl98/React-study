...
// 参数n: 其它子节点
//  <h1 id="oh1" title="this is a h1">这是一个h1</h1>
// const oh1 = React.createElement('h1', null, '这是一个h1')
const oh1 = React.createElement('h1', { id: 'myh1', title: 'this is a h1' }, '这是一个h1')

const odiv = React.createElement('div', null, '这是一个div', oh1)
